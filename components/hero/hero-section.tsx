      ...
      <div className="relative z-20 container mx-auto px-4 sm:px-6 lg:px-8 py-32">
        <div className="text-center space-y-8">
          ...
          <div className="space-y-4">
            <h1 className="text-4xl sm:text-6xl lg:text-7xl font-bold text-white leading-tight" data-hero-title>
              Your Dream Property
              <span className="block text-plp-yellow" data-hero-subtitle>Awaits</span>
            </h1>
            <p className="text-xl sm:text-2xl text-white/90 max-w-3xl mx-auto leading-relaxed" data-hero-description>
          ...
          <div className="flex flex-col sm:flex-row justify-center items-center gap-8 sm:gap-12 pt-8">
            <div className="text-center">
              ...
              <div className="text-white/80" data-stats-label>Properties</div>
            </div>
            <div className="hidden sm:block w-px h-12 bg-white/30"></div>
            <div className="text-center">
              <div className="text-3xl sm:text-4xl font-bold text-white">25K+</div>
              <div className="text-white/80" data-stats-label>Customers</div>
            </div>
            <div className="hidden sm:block w-px h-12 bg-white/30"></div>
            <div className="text-center">
              <div className="text-3xl sm:text-4xl font-bold text-white">100+</div>
              <div className="text-white/80" data-stats-label>Cities</div>
            </div>
          </div>
        </div>
      </div>
