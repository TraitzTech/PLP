        ...
        {isLoading ? (
          ...
          <div className="text-center py-12">
            <p className="text-gray-500 text-lg">
              {t("categories.none", "No property type available")}
            </p>
          </div>
        ) : (
          <>
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
              {categories.map((category) => {
                ...
                return (
                  <Card
                    key={category.id}
                    className="group cursor-pointer card-hover overflow-hidden border-0 shadow-lg"
                  >
                    ...
                    <CardContent className="p-6">
                      <div className="space-y-3">
                        ...
                        <Link
                          href={`/search?type=${category.name.toLowerCase()}`}
                        >
                          <Button
                            variant="ghost"
            ...
            <div className="flex justify-center mt-12">
              <Link href="/search">
                <Button className="btn-primary group px-8 py-6 text-lg">
                  {t("categories.view", " View All Property Types")}
