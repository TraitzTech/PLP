...
export function Navbar() {
  ...
  return (
    <nav
      className={`fixed top-0 left-0 right-0 z-50 transition-all duration-300 bg-white/95 backdrop-blur-md shadow-lg border-b border-gray-100 ${isScrolled}`}
    >
                ...
                {isAuthenticated ? (
                  ...
                  <>
                    <div className="space-y-2">
                      <p className="text-sm font-medium text-gray-700 px-3">
                        {t("auth.signInAs", "Sign In As:")}
                      </p>
                      <Button
                        variant="ghost"
