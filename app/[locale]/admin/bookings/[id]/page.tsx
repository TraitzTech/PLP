...
import { adminBookingService, Booking } from "@/services/bookingService";
...
export default function AdminReservationDetailsPage() {
  ...
  const loadBooking = async () => {
    ...
    try {
      setIsLoading(true);
      const response = await adminBookingService.getBooking(bookingId);
  ...
  const handleConfirm = async () => {
    ...
    try {
      ...
      await adminBookingService.updateStatus(booking.id, "confirmed", "Confirmed by admin");
