...
const navigationItems = [
    { nameKey: 'categories.hotels.name', href: '/search?type=hotels', icon: Building2 },
    { nameKey: 'categories.houses.name', href: '/search?type=houses', icon: Home },
    { nameKey: 'categories.land.name', href: '/search?type=land', icon: MapPin },
